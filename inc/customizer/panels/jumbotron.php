...
// General show videos
$wp_customize->add_setting( $prefix .'_jumbotron_general_show_videos',
    array(
...
$wp_customize->add_control(
    $prefix .'_jumbotron_general_show_videos',
    array(
        'label'         => esc_html__( 'Show Videos', 'illdy' ),
        'description'   => esc_html__( 'Show the header background videos?', 'illdy'),
        'section'       => $prefix . '_jumbotron_general',
        'type'          => 'checkbox',
        'priority'      => 2
    )
