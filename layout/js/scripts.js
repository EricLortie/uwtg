...
jQuery( document ).ready( function($) {
    ...
    // $('body.home').find('a[href="/"]').attr('href', '#');
    // $('body.home').find('a[href="#testimonials"]').attr('href', '/#testimonials');
    // $('body.home').find('a[href="#about"]').attr('href', '/#about');
    // $('body.home').find('a[href="#team"]').attr('href', '/#team');
    // $('body.home').find('a[href="#contact"]').attr('href', '/#contact');
    // $('body.home').find('a[href="#features"]').attr('href', '/#features');
		// $('a').on('click', function() {
	...
	function setColorOnFrontPageService() {
		...
		if( $( '#sidebar .service' ).length ) {
			$( '#sidebar .service' ).each( function() {
				var service = $( this );
				var serviceIcon = $( service ).children( '.service-icon' );
				var serviceTitle = $( service ).children( '.service-title' );
				var dataServiceColor = $( service ).data( 'service-color' );
